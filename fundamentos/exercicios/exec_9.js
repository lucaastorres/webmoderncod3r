...
a seguinte política declassificação: Todo aluno recebe uma nota de 0 a 100. 
Alunos com nota abaixo de 40 são reprovados. As notas possuem a seguinte regra 
de arredondamento: Se a diferença entre a nota e o próximo múltiplo de 5 for menor que 3, 
...
por ser abaixo de 40 e não ser possível arredondamento eficiente, ou seja, 
que evite a reprovação do aluno. No caso de a nota ser 38, o arredondamento é possível 
    ...
    if(nota < 38){
        ...
        switch (nota % 5){
            ...
            case 2:
                ...
                break
            case 3:
                console.log(`Aluno Aprovado nota: ${nota + 2}`)
                break
            case 4:
                console.log(`Aluno Aprovado nota: ${nota + 1}`)
                break
        }
    }
}
