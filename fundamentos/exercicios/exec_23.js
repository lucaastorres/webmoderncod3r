...
function calcularMediaPondera(codigoDoAluno, nota1, nota2, nota3) {
    let notas = []
    notas.push(nota1)
    notas.push(nota2)
    notas.push(nota3)
    ...
    return console.log(`Código do Aluno: ${codigoDoAluno}. Notas: ${nota1} , ${nota2}, ${nota3}. ${mediaPonderada > 5 ? 'Aprovado': 'Reprovado'}`)
}

calcularMediaPondera(001, 4, 10 , 8)
calcularMediaPondera(002, 5, 7 , 2)
calcularMediaPondera(004, 7, 5 , 9)